...
"                     \\/_____/               \\/    \\/                                     \\/     ");
        ...
        numero = (int)(Math.random()*preguntas.length);
        
        if(preguntaLibre[numero] == 0){
            if(preguntaLibre[numero] != preguntaLibre[0]){
               numero=0;
            }else{
                if(preguntaLibre[numero] != preguntaLibre[1]){
                   numero=1;
                }else{
                    if(preguntaLibre[numero] != preguntaLibre[2]){
                       numero=2;
                    }else{
                        if(preguntaLibre[numero] != preguntaLibre[3]){
                           numero=3;
                        }else{
                            if(preguntaLibre[numero] != preguntaLibre[4]){ 
                               numero=4;
                            }else{
                                if(preguntaLibre[numero] != preguntaLibre[5]){
                                   numero=5;
                                }else{
                                    if(preguntaLibre[numero] != preguntaLibre[6]){
                                       numero=6;
                                    }else{
                                        if(preguntaLibre[numero] != preguntaLibre[7]){
                                           numero=7;
                                        }
                                    }
                                }
        ...
        System.out.println("Pregunta número: "+numPregunta);
        numPregunta++;
        System.out.println(preguntas[numero]);solucion = new Scanner(System.in).nextLine();
